...
static registry_value_t root_path_keys[] = {
    ...
    {HKEY_LOCAL_MACHINE, SOFTWARE_KEY "\\GOG.com\\Games\\1776058590", "PATH"},
};
...
static char *root_path_subdirs[] = {
    ...
    "Doom2", "Final Doom", "Ultimate Doom",      "Plutonia",
    "TNT",   "base\\wads", "dos\\base\\heretic", "dos\\base\\hexen",
};
